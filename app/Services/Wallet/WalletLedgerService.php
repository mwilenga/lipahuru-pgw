...
class WalletLedgerService
{
    ...
    /**
     * Admin (or system) credit onto the single merchant balance wallet.
     */
    public function creditMerchantBalance(
        Wallet $wallet,
        string $amount,
        string $currency,
        string $reference,
        ...
        if ($wallet->wallet_type !== WalletType::MerchantBalance) {
            throw new GatewayException(
                GatewayErrorCode::GeneralError,
                'Credits can only be applied to the merchant balance wallet',
                httpStatus: 422,
            );
        }
    ...
    /**
     * @deprecated Hierarchy collapsed to MERCHANT_BALANCE; no-op for compatibility.
     */
